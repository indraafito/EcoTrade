...
import { Trophy, Award, Crown, Medal, Recycle, Weight, ArrowLeft, Search, Star, Sparkles } from "lucide-react";
...
const Leaderboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1DBF73]/5 via-background to-primary/5 pb-28">
      {/* Header */}
      <div className="relative bg-gradient-to-br from-primary via-[#17a865] to-[#1DBF73] px-6 pt-12 pb-24 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-center text-sm">
            Kompetisi Penyelamat Lingkungan
          </p>
        </div>
      </div>
      ...
      {currentUser && (
        <div className="-mt-16 px-6 mb-6 relative z-20">
          <div className="bg-card/90 backdrop-blur-xl rounded-2xl shadow-2xl p-5 border border-white/20 dark:border-white/10">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-[#1DBF73] flex items-center justify-center">
              ...
              <div className="text-right">
                ...
                >
                  {getRankIcon(currentUser.position) || `#${currentUser.position}`}
                </div>
        ...
        <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-4 border border-border/50">
          ...
          <div className="space-y-2">
            {rankingTiers.map((tier) => (
              ...
              >
                <span
                  className={`px-2 py-1 rounded-lg font-bold border ${getTierBadgeColor(
                    tier.name
                  )}`}
                >
                  {tier.name}
                ...
                <span className="text-muted-foreground">
                  {tier.threshold_points}+ poin
                </span>
                {tier.bonus_points > 0 && (
                  <span className="text-primary font-semibold">
                    +{tier.bonus_points} bonus
                  </span>
                )}
              </div>
            ))}
          ...
          {filteredLeaderboard.slice(3).map((entry) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary/20 to-[#1DBF73]/20 flex items-center justify-center">
                  {entry.avatar_url ? (
                    <img
